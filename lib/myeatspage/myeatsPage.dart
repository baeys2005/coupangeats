...
class _myeatsPageState extends State<myeatsPage> {
  ...
  void _showOwnerDialog() {
    //사장님 페이지 등록 다이얼로그 표시하는 함수
    showDialog(
        context: context,
        builder: (BuildContext context) {
          return OwnerRegistrationDialog(onOwnershipChanged: (bool isOwner) {
            setState(() {
              _isOwner = isOwner;
            });
          });
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(_formatPhoneNumber(_userPhone),
                  ...
                  OutlinedButton(
                    ...
                    child: Container(
                      ...
                      child:
                          Text('자세히 보기', style: TextStyle(color: Colors.blue)),
                    ),
            ...
            ListTile(
              ...
              leading: Icon(Icons.list_alt, size: 24),
              title: Text('주소 관리'),
  ...
  Widget _buildListTileWithButton(
      String title, IconData icon, String buttonText) {
    return ListTile(
      leading: Icon(icon, size: 24),
      title: Row(
